...
Name=$(curl -sS https://raw.githubusercontent.com/xcozyx/iz/main/ip | grep $MYIP | awk '{print $2}')
...
madmin=$(curl -sS https://raw.githubusercontent.com/xcozyx/iz/main/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
